...
public class Cloudlet {
	private int userId;
	private long cloudletLength;
	private long cloudletIntensity;//密集度
	private final long cloudletFileSize;
	private final long cloudletOutputSize;
	private int numberOfPes;
	private final int cloudletId;
	...
	public Cloudlet(int cloudletId, long cloudletLength,long cloudletIntensity, int pesNumber, long cloudletFileSize, long cloudletOutputSize, UtilizationModel utilizationModelCpu, UtilizationModel utilizationModelRam, UtilizationModel utilizationModelBw,List<String> fileList){
		this(cloudletId, cloudletLength,cloudletIntensity, pesNumber, cloudletFileSize, cloudletOutputSize, utilizationModelCpu, utilizationModelRam, utilizationModelBw, false);
		this.vmId = -1;
	...
	public Cloudlet(int cloudletId, long cloudletLength,long cloudletIntensity, int pesNumber, long cloudletFileSize, long cloudletOutputSize, UtilizationModel utilizationModelCpu, UtilizationModel utilizationModelRam, UtilizationModel utilizationModelBw, boolean record) {
		...
		this.cloudletIntensity = cloudletIntensity;
	...
	public long getCloudletIntensity() {
		return cloudletIntensity;
	}

	public boolean setCloudletIntensity(long cloudletIntensity) {
		if (cloudletIntensity<= 0L||cloudletIntensity>=1L){
			return false;
		}else{
			this.cloudletIntensity = cloudletIntensity;
			return true;
