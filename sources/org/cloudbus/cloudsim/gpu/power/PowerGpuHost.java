...
public class PowerGpuHost extends PerformanceGpuHost {
	 ...
	 *            own power models)
	 */
	public PowerGpuHost(int id, String type, RamProvisioner ramProvisioner, BwProvisioner bwProvisioner,long totalStorage, long storage,
			List<? extends Pe> peList, VmScheduler vmScheduler, VideoCardAllocationPolicy videoCardAllocationPolicy,
			PowerModel powerModel) {
		super(id, type, ramProvisioner, bwProvisioner,totalStorage,storage, peList, vmScheduler, videoCardAllocationPolicy);
